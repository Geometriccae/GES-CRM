<?php 	$this->load->view('user_includes/header',$page_data);   ?>
    ...
    <?php } ?>
    <form action="<?php echo base_url('admin/user_edit_lead/' . $id); ?>" method="post" class="row g-3 needs-validation" novalidate style="padding: 20px;">
    <div class="col-md-6">
