...
<div class="row">
    ...
    <a href="<?php echo base_url('admin/user_add_lead'); ?>" class="btn btn-primary mb-3 ">Add Lead</a>
    ...
    ?>
        <tr>
           ...
           <td><?php echo $lead['line_of_business']; ?></td>
            ...
            <td>
                <a href="<?php echo base_url('admin/user_edit_lead/' . $lead['id']); ?>" class="btn btn-primary btn-sm">Edit</a>
                <a href="<?php echo base_url('admin/user_delete_lead/' . $lead['id']); ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this lead?')">Delete</a>
            </td>
        </tr>
        <?php
