        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <a href="<?php echo base_url('ActivityController/user_create'); ?>" class="btn btn-primary mb-3">Create New Activity</a>
...
<td><?php echo $activity->Links; ?></td>
 <!-- Display Links -->
                <td>
                    <a href="<?php echo base_url('ActivityController/useredit/' . $activity->ActivityID); ?>" class="btn btn-primary waves-effect waves-light">Edit</a>
                    <a id="sa-warning" href="<?php echo base_url('ActivityController/user_delete/' . $activity->ActivityID); ?>" class="btn btn-danger waves-effect waves-light">Delete</a>
