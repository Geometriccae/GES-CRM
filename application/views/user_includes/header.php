                ...
                <div data-simplebar class="h-100">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu list-unstyled" id="side-menu">
                            ...
                            <li>
                                <a href="<?php echo base_url();?>User_task/index" class="waves-effect">
                                    <span class="badge rounded-pill bg-info float-end"></span>
                            ...
                            <li>
                                <a href="<?php echo base_url();?>admin/user_lead" class="waves-effect">
                                    <span class="badge rounded-pill bg-info float-end"></span>
                                    <i class="fas fa-envelope-open-text"></i>
                            ...
                            <li>
                                <a href="<?php echo base_url();?>Deal_it_service/user_index" class="waves-effect">
                                    <span class="badge rounded-pill bg-info float-end"></span>
                                    <i class="fas fa-envelope-open-text"></i>
                                    <span>Deal IT Services </span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url();?>ActivityController/user_index" class="waves-effect">
                                    <span class="badge rounded-pill bg-info float-end"></span>
