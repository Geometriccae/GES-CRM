<?php 	$this->load->view('includes/header',$page_data);   ?><!-- services_list.php -->
...
<div class="row">
    ...
    <a href="<?php echo base_url('Deal_it_service/create'); ?>" class="btn btn-primary mb-3">Add New Service</a>
    ...
    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
        ...
        <tr>
            ...
            <td>
                <a href="<?= site_url('deal_it_service/edit/' . $service->IT_services_id) ?> " class="btn btn-primary btn-sm">Edit</a>
                <a href="<?= site_url('deal_it_service/delete/' . $service->IT_services_id) ?>"  class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this lead?')">Delete</a>
            </td>
        </tr>
        <?php endforeach; ?>
</tbody>
