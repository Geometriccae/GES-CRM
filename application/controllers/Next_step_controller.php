...
class LeadServicesRequired_controller extends CI_Controller {
    ...
    public function index() {
        ...
        $this->load->view('lead_services_required/services_required_list', $data);
    ...
    public function add_service_required() {
        if ($this->input->post()) {
            ...
            redirect('LeadServicesRequired_controller/index');
        } else {
            $this->load->view('includes/header', $page_data);
            $this->load->view('lead_services_required/add_service_required');
            $this->load->view('includes/footer', $page_data);
        }
    }
    ...
    public function edit_service_required($id) {
        if ($this->input->post()) {
            ...
            $this->load->view('includes/header', $page_data);
            $this->load->view('lead_services_required/edit_service_required', $data);
            $this->load->view('includes/footer', $page_data);
        }
    }
